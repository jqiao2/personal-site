...
| [0023](patterns/0023-merge-duplicate-rows-via-self-fk.md) | Merge duplicate rows non-destructively via a self-FK | strategy | the same real thing is several rows in one table, a computed flag desyncs across them, or dedupe rows other tables reference |
